...
public class TaskSchedule {
    ...
    public static void runAllTasksInExecutor(ArrayList<SafelyRunnable> runnableList, 
        Executor executor, int parallelTasks) {
    ...
    public static void runTasks(ArrayList<SafelyRunnable> runnableList, Executor executor, 
        int parallelTasks, long timeOut) {
        int taskSize = runnableList.size();
